/*
    ...
    Description
        Register certain object to be a service point for the aircraft.
            ...
            [this, "REPAIR" or "REFUEL" or "REARM" or ["REPAIR", "REARM"] + others combinations] call PIG_fnc_registerService; // Register an object with just one service

    Parameter(s):
        _vehicle - vehicle that will serve as a service for aircraft [OBJECT, defaults to objNull] 
        _role - service's role, can be "REPAIR", "REFUEL", "REARM" [STRING or ARRAY, defaults to ""]
