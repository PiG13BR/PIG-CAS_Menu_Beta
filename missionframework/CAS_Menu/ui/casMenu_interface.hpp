...
class Health_bar: RscProgress
{
	...
	x = 0.191672 * safezoneW + safezoneX;
...
class Text_aircraft: RscText
{
	...
	text = "Aircraft";
	x = 0.138191 * safezoneW + safezoneX;
...
class Text_ammo: RscText
{
	...
	text = "Ammo";
	x = 0.145751 * safezoneW + safezoneX;
	y = 0.696044 * safezoneH + safezoneY;
...
class CheckBox_camera: RscCheckbox
{
	idc = 3632800;
...
class Text_status: RscText
{
	...
	x = 0.139091 * safezoneW + safezoneX;
